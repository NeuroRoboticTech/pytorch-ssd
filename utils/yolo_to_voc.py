...
# path root folder
# ROOT = '/media/dcofer/Ubuntu_Data/active_shooter_defense/gun_dataset/detector/ssd/test'
# ROOT = '/media/dcofer/Ubuntu_Data/active_shooter_defense/gun_dataset/detector/ssd/validation'
ROOT = '/media/dcofer/Ubuntu_Data/active_shooter_defense/gun_dataset/detector/ssd/train'
...
def xml_transform(root, classes):  
    ...
    for i in range(len(ids)):
        ...
        if img is None:
            raise RuntimeError("Image not found for yolo label file: {}".format(img_id))
        ...
        node_database.text = 'gun database'
