...
# output_img_dir = '/media/dcofer/3922-2939/group_' + str(partition_group + 1) + '/images/'
# output_label_dir = '/media/dcofer/3922-2939/group_' + str(partition_group + 1) + '/labels/'
...
output_label_dir = '/media/dcofer/Ubuntu_Data/active_shooter_defense/gun_dataset/detector/other/train/group_' + \
                   str(partition_group + 1) + '/labels/'
